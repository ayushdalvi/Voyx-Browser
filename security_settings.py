...
class SecuritySettingsPanel(QWidget):
    ...
    def setup_ui(self):
        ...
        self.block_phishing_cb = QCheckBox("Block phishing sites")
        self.block_phishing_cb.setToolTip("Block known phishing sites from PhishTank")
        privacy_layout.addWidget(self.block_phishing_cb)
    ...
    def load_settings(self):
        ...
        self.block_phishing_cb.setChecked(settings.get('block_phishing', True))
    ...
    def apply_settings(self):
        ...
        self.security_manager.set_block_phishing(self.block_phishing_cb.isChecked())
    ...
    def reset_settings(self):
        ...
        self.block_phishing_cb.setChecked(True)
    ...
    def get_settings(self):
        ...
        return {
            ...
            'block_phishing': self.block_phishing_cb.isChecked(),
